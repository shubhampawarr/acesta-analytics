...
/**
 * The artist portfolio is deliberately absent. Its source is a single 900px
 * page of near-flat cream — mean luminance 254 with a tonal spread of 13.4 —
 * so no luminance-to-colour mapping can give it range, and the duotone comes
 * out as a solid gold rectangle. §6 permits photography but does not require
 * it; that row stays typographic rather than carrying a decorative slab.
 */
const PROJECTS = [
