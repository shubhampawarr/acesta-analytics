      ...
      <div className="premium-container">
        <Reveal y={18}>
          <div className="premium-card mx-auto max-w-4xl rounded-[1.5rem] px-5 py-8 text-center md:rounded-[2rem] md:px-8 md:py-10 lg:px-10">
            ...
            <h2 className="font-display mx-auto mt-3 max-w-3xl text-4xl font-semibold leading-[0.9] tracking-[-0.055em] text-[#f8f4ea] md:mt-4 md:text-6xl">
              Build sharper. Launch cleaner.
            </h2>

            <p className="mx-auto mt-4 max-w-xl text-xs leading-6 text-[#b8b0a3] md:mt-5 md:text-sm md:leading-7">
